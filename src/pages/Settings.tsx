  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex-1 lg:ml-64"> {/* Margin only on larger screens */}
        <Header />
        <div className="max-w-6xl mx-auto p-4 lg:p-6 pt-16"> {/* Added pt-16 for header space */}
          {/* Settings Header */}
              ...
              <div>
                ...
                <ul className="space-y-4 text-sm">
                  <li className="ml-0 lg:ml-4">
                    <span className="font-medium block lg:inline">Password Management:</span>{" "}
                  ...
                  <li className="ml-0 lg:ml-4">
                    <span className="font-medium block lg:inline">Session Timeout:</span>{" "}
                    <span className="block lg:inline mt-1 lg:mt-0">
                  ...
                  <li className="ml-0 lg:ml-4">
                    <span className="font-medium block lg:inline">Security Questions:</span>{" "}
                    <span className="block lg:inline mt-1 lg:mt-0">
